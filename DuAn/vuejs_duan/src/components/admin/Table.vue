            ...
            <template v-if="table.data.length > 0">    
                <tr v-for="(val, key) in table.data" :key="key">
                    ...
                    <td class="text-center uk-flex-center uk-flex">
                        <router-link :to=table.route.update class="btn btn-primary mr10"><i class="bx bx-edit"></i></router-link>
                        <router-link :to=table.route.delete class="btn btn-danger"><i class="bx bx-trash"></i></router-link>
                        <template v-if="table.action.length > 0">
                            <router-link v-for="(action, actionIndex) in table.action"
                            :key="actionIndex"
                            :to="action.route"
